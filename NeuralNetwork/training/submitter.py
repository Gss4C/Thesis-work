...
def sub_writer(signal):
    ...
    f.write("arguments               = "+ signal +"\n")
    #f.write("input                   = input.txt\n")
    f.write("output                  = condor/output/"+signal+".out\n")
    f.write("error                   = condor/error/" +signal+".err\n")
    f.write("log                     = condor/log/"   +signal+".log\n")
...
signal_list = ['TP_700' , 'TP_1000', 'TP_1800']
