...
every_sig_list = ["TprimeToTZ_1800_2018", "TprimeToTZ_1000_2018", "TprimeToTZ_700_2018"] #TOPP
every_bg_list  = [
...
datas = json_reader(meta_data['meta_info']['eos_sig_jsons']+'forsig_th_'+ str(opt.threshold)+'.json') 
##########################
#########################
...
for signal in every_sig_list:
    ...
    plt.savefig(meta_data['meta_info']['eos_sig'] + str(opt.threshold)+'_Significance_' + signal + '.png')
    plt.close()