...
def sub_writer(cluster):
    ...
    f.write("output                  = ef_condor/output/"+'histo'+str(10)+ cluster+".out\n")
    f.write("error                   = ef_condor/error/" +'histo'+str(10)+ cluster+".err\n")
    f.write("log                     = ef_condor/log/"   +'histo'+str(10)+ cluster+".log\n")

    f.write("queue\n")

if not os.path.exists("ef_condor/output"):
    os.makedirs("ef_condor/output")
if not os.path.exists("ef_condor/error"):
    os.makedirs("ef_condor/error")
if not os.path.exists("ef_condor/log"):
    os.makedirs("ef_condor/log")
if(uid == 0):
...
for cluster in cluster_list:
    sub_writer(cluster)
    os.popen('condor_submit ef_condor.sub')
    print("SUBMITTED")
    time.sleep(5)
